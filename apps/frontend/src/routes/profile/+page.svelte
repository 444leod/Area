    ...
    function initBackground() {
        ...
        function animate() {
            ...
            for (let i = 0; i < particleCount; i++) {
                ...
                ctx.fillStyle = 'rgb(var(--color-primary-500) / 0.5)';
                ctx.fill();
            }
        }
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="card profile-card p-8 mb-12">
                <div class="flex flex-col md:flex-row items-center mb-8">
                    <div class="w-32 h-32 bg-primary-500 rounded-full flex items-center justify-center text-white text-5xl font-bold mb-4 md:mb-0 md:mr-8 shadow" aria-hidden="true">
            ...
            <div class="mt-12 flex justify-center">
                <button class="btn btn-hover variant-filled-error" color="error" size="lg" on:click={handleLogout}>
