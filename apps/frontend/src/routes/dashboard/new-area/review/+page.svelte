<script lang="ts">
    ...
    onMount(() => {
        if (!$areaStore.triggerApp || !$areaStore.selectedTrigger ||
            !$areaStore.actionApp || !$areaStore.selectedAction ||
            !$areaStore.actionDetails || !$areaStore.reactionDetails) {
...
<div class="space-y-6" in:fade>
        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 rounded-full variant-filled-surface flex items-center justify-center">
    ...
    >
        ...
        <input type="hidden" name="reactionDetails" value={JSON.stringify($areaStore.reactionDetails)} />
        ...
        <div class="card variant-ghost p-4">
            <div class="flex items-start gap-4">
                ...
                <div class="space-y-2">
                    ...
                    <p class="text-sm">
                        When <span class="text-primary-500">{$areaStore.triggerApp?.name}</span> {$areaStore.selectedTrigger?.description?.toLowerCase() || ''},
