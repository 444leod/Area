...
<div class="space-y-6" in:fade>
	...
	<div class="flex items-center gap-4 p-4 card variant-soft">
		<Icon icon={getIconForApp(triggerApp?.name || '')} class="w-12 h-12" />
		<div>
	...
	<div class="card variant-ghost p-4">
		<div class="flex items-start gap-4">
			...
			<div class="text-sm">
				...
				<p>
					Select what event should start your automation. Each trigger can provide variables that
					you can use in your actions later.
				</p>
			</div>
		</div>
	</div>
