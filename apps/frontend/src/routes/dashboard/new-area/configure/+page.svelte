    ...
    <div class="card variant-ghost p-4">
        <div class="flex items-start gap-4">
            ...
            <div class="text-sm">
                ...
                <p>Set up the details for both your trigger and action. You can use variables from your trigger in the action configuration by clicking the "Dynamic" button.</p>
                {#if $dynamicVariablesStore.length > 0}
                    <p class="mt-2">
                        Available variables are shown in the panel on the left. Use them to make your automation more dynamic!
                    </p>
                {/if}
            </div>
        </div>
