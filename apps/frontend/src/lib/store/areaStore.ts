...
function createAreaStore() {
    ...
    return {
        ...
        setSelectedTrigger: (trigger: Action) => update(state => ({
            ...state,
        ...
        setSelectedAction: (action: Action) => update(state => ({
            ...state,
        ...
        setAutomationName: (name: string) => update(state => ({
            ...state,
            automationName: name
        })),
        updateActionParam: (paramName: string, value: any) => update(state => ({
            ...state,
            actionDetails: {
                ...state.actionDetails,
                params: {
        ...
        updateReactionParam: (paramName: string, value: any) => update(state => ({
            ...state,
            reactionDetails: {
