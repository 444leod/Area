...
const StringInput: React.FC<StringInputProps> = ({param, value, updateParamValue, required, dynamicVariables, isAction}) => {
    const [isUsingVariable, setIsUsingVariable] = useState(false);
    const [selectedVariable, setSelectedVariable] = useState('');

    // Filter only string variables
    const stringVariables = dynamicVariables.filter(v =>
        v.type === 'string' ||
        v.type === 'text' ||
