  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 3:
        ...
        const items =
          currentStep === 1 ? currentApp.triggers : currentApp.actions;
        return (
          <>
            <Title style={styles.stepTitle}>
          ...
          <>
            ...
            {selectedTrigger === "EXAMPLE_ACTION" && (
              <TextInput
                ...
                onChangeText={(text) =>
                  setActionDetails({ ...actionDetails, exampleField: text })
                }
                style={styles.input}
                mode="outlined"
              />
            ...
            {selectedAction === "SEND_EMAIL" && (
              <>
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setReactionDetails({ ...reactionDetails, to: text })
                  }
                  style={styles.input}
                  mode="outlined"
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setReactionDetails({ ...reactionDetails, subject: text })
                  }
                  style={styles.input}
                  mode="outlined"
                />
