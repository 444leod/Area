        ...
        <View style={styles.card}>
            ...
            <View style={styles.messageContainer}>
                ...
                <Text style={styles.messageText}>
                    Cette fonctionnalité est disponible uniquement sur la version web de l'application
                </Text>
            </View>
...
const ServiceConnectionsScreen = ({ authorizations = [] }) => {
    ...
    const services = [
        {
            name: "Google",
            description: "Connectez-vous à Google pour accéder à Gmail, Calendar, Drive et d'autres services Google dans vos automatisations",
            icon: "logo-google",
        ...
        {
            name: "Atlassian",
            description: "Intégrez Jira, Confluence et d'autres outils Atlassian pour une meilleure gestion de projets",
        ...
        {
            name: "GitHub",
            description: "Accédez à vos repositories, issues et pull requests GitHub pour automatiser votre workflow de développement",
            icon: "logo-github",
        ...
        {
            name: "Spotify",
            description: "Connectez-vous à Spotify pour gérer vos playlists et votre musique automatiquement",
