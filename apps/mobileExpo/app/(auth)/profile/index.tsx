          ...
          <Card key={area._id} style={styles.card}>
            <Card.Content>
              <View style={styles.cardHeader}>
                <Text style={styles.cardTitle}>{area.action.informations.type} → {area.reaction.informations.type}</Text>
                <Chip 
                  icon={area.active ? "check-circle" : "close-circle"} 
                  mode='outlined'
                  style={{ backgroundColor: area.active ? theme.colors.success : theme.colors.error }}
                >
